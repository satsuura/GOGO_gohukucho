...
function a() {
    //呉服町ゲート　34.976105,138.378899
    //静岡駅　34.972189,138.388900
    // 緯度
    var lat=34.972189;
    // 経度
    var lng=138.388900;
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            for(var f=1;f<12;f++){
                //配列から取り出し
                insert[f]="<a href='http://maps.google.com/maps?saddr="+lat+","+lng+"&daddr="+jname[f]+"&dirflg=w'>"+f+"."+bname[f]+"<br/>静岡駅から"+bname[f]+"まで約"+kyori[f]+"m</a>";
            }
            //表示
            $('#one').html(insert[1]);
            $('#two').html(insert[2]);
